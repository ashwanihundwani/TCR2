...
@implementation NookTBS

- (void)viewDidLoad
{
    [super viewDidLoad];
     //NSURL *url = [NSURL URLWithString:fullURL];
 //   NSURL *url = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"NookTBS" ofType:@"html" inDirectory:@"www"]];
  //  NSURL *url = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"2views" ofType:@"png" inDirectory:@"www"]];
    NSString *beasMonoPath  =[[NSBundle mainBundle]pathForResource:@"NookTBS.html"  ofType:nil];
...
-(void)writeVisitedPage{
    ...
    NSString *str = @"Tips for Better Sleep";
