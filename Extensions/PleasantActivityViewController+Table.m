...
#import "PleasantActivityViewController+Table.h"

@implementation PleasantActivityViewController (Table)

-(CGFloat)heightForIndexPath:(NSIndexPath *)indexPath
{
    CGFloat constant = 27;
    
    CGFloat labelHeight = [Utils heightForLabelForString:[self.activties objectAtIndex:indexPath.row] width:240 font:TITLE_LABEL_FONT];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        titleLabel.text = [self.activties objectAtIndex:indexPath.row];
