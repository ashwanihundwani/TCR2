...
#import "ImageryViewController+Table.h"

@implementation ImageryViewController (Table)
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if(indexPath.section == 0)
    {
        ...
        info.descriptionText = @"Imagery is a relaxation exercise. It can be added to Deep Breathing for a more relaxing experience.";
        
        info.skillImage = [UIImage imageNamed:@"3Imagery.png"];
    ...
    else
    {
        ...
        UIImageView *accessory = (UIImageView *)[cell viewWithTag:2345];
