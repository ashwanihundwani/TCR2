...
-(void)onClickToggleCategory:(UIButton *)sender
{
    ...
    if (section<8)
    {
        sectionForSkill = section - 1;//((section) / (maxNumberOfSkills + 1) + 1);
        
    } else if (section>8 && section <16)
        
    {
        sectionForSkill = section - 2;//
  //       sectionForSkill = section - ((section) / (maxNumberOfSkills + 1));

        
    }
    
    else if (section>16 && section <21)

    {

        sectionForSkill = section - 3;//

//        sectionForSkill = section - ((section) / (maxNumberOfSkills + 1)-1);
