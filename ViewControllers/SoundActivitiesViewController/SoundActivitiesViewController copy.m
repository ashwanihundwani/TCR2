...
-(NSArray*)loadMyDevices:(NSInteger)typeID
{
    ...
    NSString *query = [NSString stringWithFormat: @"select planID,groupID,skillID,deviceID,soundTypeID,comments,Plan_Devices.DeviceName from MyDevices left outer join   Plan_Devices on Plan_Devices.ID=MyDevices.DeviceID where soundTypeID = %ld  and planID = %@  " , (long)typeID, [PersistenceStorage getObjectForKey:@"currentPlanID"]];
...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    if ([[PersistenceStorage getObjectForKey:@"Referer"] isEqual: @"RatingsVC"]) {
        ...
        NSString *other1 = @"Know About This Skill";
...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    if  ([buttonTitle isEqualToString:@"Repeat This Skill"]) {
     ...
     //    *audioPanning = [[UIStoryboard storyboardWithName:@"Main" bundle:nil]instantiateViewControllerWithIdentifier:@"AudioPlayerOneViewController"];
    ...
    if ([buttonTitle isEqualToString:@"Know About This Skill"]) {
...
-(void)tableViewCellClicked:(NSDictionary *)soundDict
{
       ...
       NSLog(@"OSIDT DICT ID  %@",soundDict);
    
     if ([soundDict valueForKey:@"deviceID"] != nil) {
         
//NSLog(@"SOUDND DEV NAME %@",  [PersistenceStorage getObjectForKey:@"soundName"]);
...
-(void)writeViewedIntroduction{
    ...
    NSString   *finalStr = [NSString stringWithFormat:@"\r%@,%@,%@,%@,%@,%@,%@,%@,%@,%@,%@,%@,%@,%@,%@,%@",dateString,timeString,type,str,optionName,[PersistenceStorage getObjectForKey:@"planName"],[PersistenceStorage getObjectForKey:@"situationName"],[PersistenceStorage getObjectForKey:@"skillName"],nil,nil,nil,nil,nil,nil,nil,nil];
