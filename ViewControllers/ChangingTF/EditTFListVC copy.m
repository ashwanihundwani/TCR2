...
-(void)insertMyTF:(NSDictionary*)selectedTFCategories
{
    ...
    NSString *deleteQuery = [NSString stringWithFormat:@"delete from My_TF  where  planID = %d and thoughtText='%@'",planID,[selectedTFCategories valueForKey:@"thoughtsText"]];
