        ...
        for(NSDictionary *TFCategory in allTFCategoriesArray) {
            ...
            if ([[TFCategory valueForKey:@"thoughtTypeID"] isEqualToString:[TFDict valueForKey:@"thoughtTypeID"]] && [[ TFCategory valueForKey:@"ID"] isEqualToString:[TFDict valueForKey:@"thoughtTypeCategoryID"]]) {
               // NSLog(@"%@",[TFCategory valueForKey:@"thoughtTypeID"]);
                ...
                [thoughtList appendString:[TFCategory valueForKey:@"thoughtText"]];
...
-(void)insertMyTF:(NSDictionary*)selectedTFCategories
{
    ...
    NSString *inserQquery = [NSString stringWithFormat:@"insert into My_TF (planID,groupID,skillID,thoughtTypeID,thoughtTypeCategoryID,thoughtLabelText) values(%d,%d,%d,%d,%d,%@)",planID,grouID,skillID,[[selectedTFCategories valueForKey:@"thoughtTypeID"] intValue],[[selectedTFCategories valueForKey:@"ID"] intValue],[selectedTFCategories valueForKey:@"thoughtsText"]];
