...
-(void)insertMyTF:(NSDictionary*)selectedTFCategories
{
    ...
    NSString *inserQquery = [NSString stringWithFormat:@"insert into My_TF (planID,groupID,skillID,thoughtTypeID,thoughtsTypeCategoryID) values(%d,%d,%d,%d,%d)",planID,grouID,skillID,[[selectedTFCategories valueForKey:@"thoughtTypeID"] intValue],[[selectedTFCategories valueForKey:@"ID"] intValue]];
